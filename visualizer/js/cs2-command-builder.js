(function (App) {
  ...
  function buildFullBundleCommand(state, bundleMeta) {
    ...
    return [
      ...
      "",
      "& " + quoteArg(pythonExe) + " " + quoteArg(".\\tools\\validate_cs2_bundle.py") + " `",
      "  --bundle $bundle `",
      "  --bundle-index " + quoteArg(".\\exports\\bundles\\bundle_index.json") + " `",
      "  --require-active",
      "",
      "Assert-PythonSuccess " + quoteArg("Validation intégrale du bundle"),
      "",
      ...
      "",
      "& " + quoteArg(pythonExe) + " " + quoteArg(".\\tools\\sync_citytimeline_bundle.py") + " `",
      "  --source-root " + quoteArg(".\\exports\\bundles") + " `",
      "  --target-root $timelineBundles `",
      "  --bundle-id $bundleId",
      "",
      "Assert-PythonSuccess " + quoteArg("Synchronisation atomique vers CityTimelineMod"),
      "",
      "tree $bundle /F"
    ].join("\n");
  }
